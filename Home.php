...
<h3>Prepare for a Successful Career in Industry 4.0</h3>
	 ...
	 <form action="https://formsubmit.co/m18176587@gmail.com" enctype="multipart/form-data" method="POST" >
    	<input type="hidden" name="_template" value="table">
	<input type="hidden" name="_next" value="http://www.mdaniyaljahangir.online/submit.html">
	...
	<input id="field-wnd_EmailField_942930796" name="wnd_EmailField_942930796" required value="@" type="email" maxlength="255">
</div></div>
		</fieldset>
		...
		<div class="form-submit b-btn cf b-btn-fs b-btn-3">
			<button class="b-btn-l" type="submit" name="send" value="wnd_FormBlock_476742903">
			...
			<div class="s-c s-f-l-w">
				<div class="s-f-l b-s b-s-t0 b-s-b0">
					<div class="s-f-l-c s-f-l-c-first">
						<div class="s-f-sf">
							<span class="sf b">
<span class="sf-content sf-c link">Powered by <a href="http://mdaniyaljahangir.online" target="_blank">Muhammad Daniyal</a></span>
</span>
						</div>
					</div>
